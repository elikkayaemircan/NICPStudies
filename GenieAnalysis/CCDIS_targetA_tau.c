{
    ...
    TH1F *h1 = new TH1F("Emircan", "Target for #nu_{#tau} interactions", 10, 200, 210);
    h1->SetLineColor(1);
    h1->SetLineWidth(2);
    TH1F *h2 = new TH1F("Annarita", "Target for #nu_{#tau} interactions", 10, 200, 210);
    h2->SetLineColor(2);
    h2->SetLineWidth(2);
