...
//int main(void)  {
{
    ...
    TFile *f_e = new TFile("/afs/cern.ch/work/e/etepe2/Emircan_v2.10.0_CharmCCDIS_100K/nu_mu/genie-nu_mu.root");
    TTree *t_e = (TTree*)f_e->Get("gst");

    TFile *f_a = new TFile("/afs/cern.ch/work/e/etepe2/Annarita_TRuf/genie-nu_mu.root");
    ...
    TH1F *h1 = new TH1F("Emircan", "Incoming neutrino (#nu_{#mu}) energy", 50, 0, 200);
    h1->SetLineColor(1);
    TH1F *h2 = new TH1F("Thomas", "Incoming neutrino (#nu_{#mu}) energy", 50, 0, 200);
    h2->SetLineColor(2);
