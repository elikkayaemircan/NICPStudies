...
//int main(void)  {
{
    ...
    TH1F *h1 = new TH1F("Emircan", "Incoming neutrino (#bar{#nu}_{#tau}) energy", 50, 0, 200);
    h1->SetLineColor(1);
    TH1F *h2 = new TH1F("Annarita", "Incoming neutrino (#bar{#nu}_{#tau}) energy", 50, 0, 200);
    h2->SetLineColor(2);
