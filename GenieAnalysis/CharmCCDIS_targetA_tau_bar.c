{
    ...
    TH1F *h1 = new TH1F("Emircan", "CharmCCDIS events nuclear target A for #bar{#nu}_{#tau}", 10, 200, 210);
    h1->SetLineColor(1);
    h1->SetLineWidth(2);
    TH1F *h2 = new TH1F("Annarita", "CCDIS events nuclear target A for #bar{#nu}_{#tau}", 10, 200, 210);
    h2->SetLineColor(2);
    h2->SetLineWidth(2);
    ...
    c->Print("CharmCCDIS_targetA_tau_bar.pdf");
}
