{
    ...
    TH1F *h1 = new TH1F("Emircan", "#bar{#nu}_{#tau} energy spectrum", 50, 0, 200);
    h1->SetLineColor(1);
    h1->SetLineWidth(2);
    ...
    TH1F *h2 = new TH1F("Annarita", "#bar{#nu}_{#tau} energy spectrum", 50, 0, 200);
    h2->SetLineColor(2);
    h2->SetLineWidth(2);
    ...
    c->Print("CharmCCDIS_energy_tau_bar.pdf");
