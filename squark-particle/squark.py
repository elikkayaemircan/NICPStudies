...
bjor_txt = open('bjor_nu_mu.txt', 'w')
inel_txt = open('inel_nu_mu.txt', 'w')
ener_txt = open('ener_nu_mu.txt', 'w')
...
h_bjor.Draw()
c.Print('bjor_binning_nu_mu.pdf')
c.Update()

h_inel.Draw()
c.Print('inel_binning_nu_mu.pdf')
c.Update()

h_ener.Draw()
c.Print('ener_binning_nu_mu.pdf')
c.Update()
