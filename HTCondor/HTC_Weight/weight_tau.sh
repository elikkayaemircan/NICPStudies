...
export GXMLPATH=/eos/experiment/ship/user/eelikkaya/NICPStudies/Inputs

RandIn=$( ls /eos/experiment/ship/user/eelikkaya/NICPStudies/Inputs/XSec/nu_tau-* | shuf -n 1 )
...
gevgen -n 100000 -p $f_pdg -t 1000822040[0.014],1000822060[0.241],1000822070[0.221],1000822080[0.524] -e 0.0,350.0 --run 1016 -f $INPUTPATH/pythia8_Geant4_wo2d_withCharm_nu.root,1016 --cross-sections $RandIn --event-generator-list CharmCCDIS --message-thresholds $GENIE/config/Messenger_laconic.xml --seed $RandNo &&
