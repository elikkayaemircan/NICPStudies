...
cret_ch.Add('events/C_nu_mu_p1.root')
cret_ch.Add('events/C_nu_mu_p4.root')
cret_ch.Add('events/C_nu_mu_p9.root')
...
h3 = r.TH2F('tplane', 'Neutrino Interactions at Transverse Plane of The Target', 100, -50, 50, 100, -50, 50)
h4 = r.TH1F('z-axis', 'Neutrino Interactions at Z-axis of The Target', 100, -3350, -3030)
h5 = r.TH1F('energy_nu', 'Incoming Neutrino Energy Spectrum', 100, 0, 200)
h6 = r.TH1F('energy_hshow', 'Hadronic Shower Energy Spectrum', 100, 0, 200)
h7 = r.TH1F('flength', 'Flight Length of Charmed Hadrons', 100, 0., 1.)
...
h5.Draw()
c.Print('energy_nu_mu.pdf')
c.Update()

h6.GetXaxis().SetTitle("Energy (GeV)")

h6.Draw()
c.Print('energy_hshow_nu_mu.pdf')
c.Update()

h7.GetXaxis().SetTitle("Flight Length (cm)")

h7.Draw()
c.Print('flength_nu_mu.pdf')
c.Update()

r.gStyle.SetOptStat(0)

h8.GetXaxis().SetBinLabel(1, "D^{+}")
h8.GetXaxis().SetBinLabel(2, "D^{0}")
