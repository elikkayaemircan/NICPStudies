...
def init():
  ...
  ap.add_argument('-ProcId', type=int, help="proc id to be processed", dest='n_proc', default=None)
...
fn = r.TFile(work_dir+'/'+str(n_proc)+'_'+flav+'.root', 'recreate')
...
print 'Processing event file in the the folder:', n_proc

f = r.TFile(input_path+'/7294899.'+str(n_proc)+'/ship.conical.Genie-TGeant4.root')

try: t = f.cbmsim
except AttributeError: 'The file in the directory '+str(n_proc)+' is broken!'
else:
  nEnt = t.GetEntries()
  t.GetEntry(0)
  mcT = t.MCTrack
