...
ut.bookHist(h, 'gC1E', 'Charmed Hadron Energy Spectrum D+', 100, 0, 100)
ut.bookHist(h, 'gC1ES', 'Charmed Hadron Energy Spectrum D+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'gC2E', 'Charmed Hadron Energy Spectrum D0', 100, 0, 100)
ut.bookHist(h, 'gC2ES', 'Charmed Hadron Energy Spectrum D0 (Selected)', 100, 0, 100)
ut.bookHist(h, 'gC3E', 'Charmed Hadron Energy Spectrum Ds+', 100, 0, 100)
ut.bookHist(h, 'gC3ES', 'Charmed Hadron Energy Spectrum Ds+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'gC4E', 'Charmed Hadron Energy Spectrum Lc+', 100, 0, 100)
ut.bookHist(h, 'gC4ES', 'Charmed Hadron Energy Spectrum Lc+ (Selected)', 100, 0, 100)
...
ut.bookHist(h, 'gC1M2', 'Charmed Hadron Multiplicity at Secondary Vertex D+', 6, 0, 6)
ut.bookHist(h, 'gC1M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'gC2M2', 'Charmed Hadron Multiplicity at Secondary Vertex D0', 6, 0, 6)
ut.bookHist(h, 'gC2M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D0 (Selected)', 6, 0, 6)
ut.bookHist(h, 'gC3M2', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+', 6, 0, 6)
ut.bookHist(h, 'gC3M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'gC4M2', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+', 6, 0, 6)
ut.bookHist(h, 'gC4M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'lC1E', 'Charmed Hadron Energy Spectrum D+', 100, 0, 100)
ut.bookHist(h, 'lC1ES', 'Charmed Hadron Energy Spectrum D+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'lC2E', 'Charmed Hadron Energy Spectrum D0', 100, 0, 100)
ut.bookHist(h, 'lC2ES', 'Charmed Hadron Energy Spectrum D0 (Selected)', 100, 0, 100)
ut.bookHist(h, 'lC3E', 'Charmed Hadron Energy Spectrum Ds+', 100, 0, 100)
ut.bookHist(h, 'lC3ES', 'Charmed Hadron Energy Spectrum Ds+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'lC4E', 'Charmed Hadron Energy Spectrum Lc+', 100, 0, 100)
ut.bookHist(h, 'lC4ES', 'Charmed Hadron Energy Spectrum Lc+ (Selected)', 100, 0, 100)
...
ut.bookHist(h, 'lC1M2', 'Charmed Hadron Multiplicity at Secondary Vertex D+', 6, 0, 6)
ut.bookHist(h, 'lC1M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'lC2M2', 'Charmed Hadron Multiplicity at Secondary Vertex D0', 6, 0, 6)
ut.bookHist(h, 'lC2M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D0 (Selected)', 6, 0, 6)
ut.bookHist(h, 'lC3M2', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+', 6, 0, 6)
ut.bookHist(h, 'lC3M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'lC4M2', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+', 6, 0, 6)
ut.bookHist(h, 'lC4M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'dC1E', 'Charmed Hadron Energy Spectrum D+', 100, 0, 100)
ut.bookHist(h, 'dC1ES', 'Charmed Hadron Energy Spectrum D+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'dC2E', 'Charmed Hadron Energy Spectrum D0', 100, 0, 100)
ut.bookHist(h, 'dC2ES', 'Charmed Hadron Energy Spectrum D0 (Selected)', 100, 0, 100)
ut.bookHist(h, 'dC3E', 'Charmed Hadron Energy Spectrum Ds+', 100, 0, 100)
ut.bookHist(h, 'dC3ES', 'Charmed Hadron Energy Spectrum Ds+ (Selected)', 100, 0, 100)
ut.bookHist(h, 'dC4E', 'Charmed Hadron Energy Spectrum Lc+', 100, 0, 100)
ut.bookHist(h, 'dC4ES', 'Charmed Hadron Energy Spectrum Lc+ (Selected)', 100, 0, 100)
...
ut.bookHist(h, 'dC1M2', 'Charmed Hadron Multiplicity at Secondary Vertex D+', 6, 0, 6)
ut.bookHist(h, 'dC1M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'dC2M2', 'Charmed Hadron Multiplicity at Secondary Vertex D0', 6, 0, 6)
ut.bookHist(h, 'dC2M2S', 'Charmed Hadron Multiplicity at Secondary Vertex D0 (Selected)', 6, 0, 6)
ut.bookHist(h, 'dC3M2', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+', 6, 0, 6)
ut.bookHist(h, 'dC3M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Ds+ (Selected)', 6, 0, 6)
ut.bookHist(h, 'dC4M2', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+', 6, 0, 6)
ut.bookHist(h, 'dC4M2S', 'Charmed Hadron Multiplicity at Secondary Vertex Lc+ (Selected)', 6, 0, 6)
  ...
  if (t.IntInGeo.at(0)):
    ...
    if ch == 16:
      if GeometrySelection(Pos):
        tGS += 1.
        C1P6g.append(True)
      else: C1P6g.append(False)
      if True in LS:
        tLS += 1.
        C1P6l.append(True)
      else: C1P6l.append(False)
      if True in DSS:
        tDSS += 1.
        C1P6d.append(True)
    ...
    if ch == 26:
      if GeometrySelection(Pos):
        tGS += 1.
        C2P6g.append(True)
      else: C2P6g.append(False)
      if True in LS:
        tLS += 1.
        C2P6l.append(True)
      else: C2P6l.append(False)
      if True in DSS:
        tDSS += 1.
        C2P6d.append(True)
    ...
    if ch == 36:
      if GeometrySelection(Pos):
        tGS += 1.
        C3P6g.append(True)
      else: C3P6g.append(False)
      if True in LS:
        tLS += 1.
        C3P6l.append(True)
      else: C3P6l.append(False)
      if True in DSS:
        tDSS += 1.
        C3P6d.append(True)
    ...
    if ch == 46:
      if GeometrySelection(Pos):
        tGS += 1.
        C4P6g.append(True)
      else: C4P6g.append(False)
      if True in LS:
        tLS += 1.
        C4P6l.append(True)
      else: C4P6l.append(False)
      if True in DSS:
        tDSS += 1.
        C4P6d.append(True)
...
print '********************************************************************** Geometry Selection Success %.4f' %(tGS/inGeo*100)
...
print '********************************************************************* Location Selection Success %.4f' %(tLS/inGeo*100)
...
print '****************************************************************** Decay Search Selection Success %.4f' %(tDSS/inGeo*100)
