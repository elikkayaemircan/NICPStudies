...
fn = r.TFile('/afs/cern.ch/user/e/eelikkay/analysis_v2/nu_mu_bar/nu_mu_bar.root', 'recreate')
...
for d in xrange(100):
    ...
    f = r.TFile('/eos/experiment/ship/user/eelikkaya/events_geo/event_CharmCCDIS_Jul18/nu_mu_bar/'+d+'/ship.conical.Genie-TGeant4.root')
    g = r.TFile('/eos/experiment/ship/user/eelikkaya/events_geo/event_CharmCCDIS_Jul18/nu_mu_bar/'+d+'/geofile_full.conical.Genie-TGeant4.root')
